...
<script src="<?php echo base_url('assets/social/'); ?>/js/jquery.min.js" type="text/javascript"></script>
<!-- jQuery UI 1.10.3 -->
...
<script src="<?php echo base_url('assets/social/'); ?>/js/raphael-min.js" type="text/javascript"></script>
<!-- Morris.js charts -->
